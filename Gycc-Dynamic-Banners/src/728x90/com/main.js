...
function animate(){
    ...
    // f3
    .from(bg2_2x, 1.5, {opacity:0, ease:Power2.easeOut},"f3-=.5")
    .from(c1_2x, 1, {y:dimensions.height/.5, ease:Power2.easeOut},"f3-=.8")
    .to(c1_2x, .7, {opacity:0, ease:Power2.easeOut},"+=2.5")
    
    .from(bg3_2x, 1.5, {opacity:0, ease:Power2.easeOut},"f4-=.5")
    .from(c2_2x, 1, {y:dimensions.height/.5, ease:Power2.easeOut},"f4-=.8")
    .to(c2_2x, .7, {opacity:0, ease:Power2.easeOut},"+=2.5")

    .to(ef_2x, 1, {width: "481px", ease:Power2.easeOut},"f5-=1")
    .from(c3_2x, 1, {y:dimensions.height/.5, ease:Power2.easeOut},"f5-=.8")
